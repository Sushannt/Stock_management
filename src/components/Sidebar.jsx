    ...
    <div className="nav-left-sidebar sidebar-dark">
        <div className="menu-list">
            <nav className="navbar navbar-expand-lg navbar-light">
                <Link to='#' className="d-xl-none d-lg-none">Dashboard</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav flex-column">
                        ...
                        <li className="nav-item ">
                            <Link className="nav-link active" to="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i className="fa fa-fw fa-user-circle"></i>Masters <span className="badge badge-success">6</span></Link>
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" to="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i className="fa fa-fw fa-rocket"></i>Input Form</Link>
